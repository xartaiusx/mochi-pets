...
- Guild landmarks: Sifu Narao, guild seal chest, spirit habitat grove, journal pavilion, expedition gate, route invitation altar, technique dojo, tactic scroll stand, affinity dais, party banner, training ring, quest board, guild rank bell, market board, trade post, and Canary shrine each need a unique silhouette and contact shadow.
