...
export const PLAYABLE_CONTENT_CATALOG = {
  ...
  roleplay: {
    ...
    dialogueScrollIds: idsFrom(MOCHI_DIALOGUE_SCROLLS),
    ...
    rosterCabinetIds: idsFrom(SPIRIT_ROSTER_CABINETS),
    nameBannerRiteIds: idsFrom(SPIRIT_NAME_BANNER_RITES),
    fieldAlmanacIds: idsFrom(SPIRIT_FIELD_ALMANACS),
    routeEcologySurveyIds: idsFrom(SPIRIT_ROUTE_ECOLOGY_SURVEYS),
    routeCharterIds: idsFrom(SPIRIT_ROUTE_CHARTERS),
  ...
  economyAndCanary: {
    ...
    remedyPouchIds: idsFrom(SPIRIT_REMEDY_POUCHES),
