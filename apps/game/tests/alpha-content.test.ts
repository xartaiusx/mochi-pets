...
describe('Mochi Spirits alpha content contract', () => {
  ...
  it('proves the no-injury battle, loadout, trait, condition, growth, and mentor readiness chain', () => {
    ...
    const blockedSummitCircuit = resolveSpiritSummitCircuit({
      partyIds: fullRoster,
      ...
      guildBuddyProof: true,
      statusMood: 'cozy',
      chatLines: ['Summit circuit ready.']
    });
    expect(blockedSummitCircuit).toMatchObject({
      cleared: false,
