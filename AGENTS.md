...
- Keep canonical runtime sprite IDs as `wayfarer`, `sifu-narao`, `spirit-lirabao`, `spirit-jintari`, `spirit-aozhen`, `chest`, `habitat-grove`, `training-ring`, `quest-board`, `market-board`, `trade-post`, and `canary-shrine`.
...
- The town has collision, one NPC dialog, one chest/item pickup, spirit invitation/capture, spirit training, quest-board progress, a minimal HUD, and save-backed player state.
