...
- The browser, local acceptance, visual review, and readiness checks cover `item.battle_kit`, `battleItemKits: true`, Jade Battle Kit label/state, and no-real-value Jade Battle Kit Tag payload preservation.
