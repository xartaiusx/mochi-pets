...
- `npm run alpha:rc-audit` must reject stale local evidence, operator checklist, sync approval, and report hygiene JSON when they do not match the current local HEAD, upstream, or dirty state.
