...
const checks = [
  ...
  },
  {
    ...
    includes: ['noRealValue: true', "network: 'CANARY'", 'spiritCapture: true', "'spirit.capture'", "'chain.operation_update'"]
  },
  {
  ...
  },
  {
    ...
    includes: ['Mochi town map object contract', 'runtimeEventPlacements', 'welcome-npc', 'guild-seal-chest', 'care-shrine', 'habitat-grove', 'training-ring', 'quest-board', 'market-board', 'trade-post', 'canary-shrine', 'no-real-value Enjin Canary certificate request', 'Jade Lantern Court', '25 * 18']
  },
  {
  ...
  },
  {
    ...
    includes: ['alpha-visual-review.json', 'alpha-visual-review.md', 'readGitState', 'manualPromptGate', 'pending-human-review', 'alpha:manual-prompt-review', 'observerMovement', 'guild-seal-chest', 'habitat-grove', 'training-ring', 'quest-board', 'Jade Lantern Court']
  },
  {
