...
const checks = [
  ...
  },
  {
    ...
    includes: ['noRealValue: true', "network: 'CANARY'", 'spiritCapture: true', 'spiritJournal: true', 'partyFormation: true', 'sparringLadder: true', "'spirit.capture'", "'spirit.journal'", "'party.set'", "'battle.spar_ladder'", "'chain.operation_update'"]
  },
  {
  ...
  },
  {
    ...
    includes: ['Mochi town map object contract', 'runtimeEventPlacements', 'welcome-npc', 'guild-seal-chest', 'care-shrine', 'habitat-grove', 'journal-pavilion', 'training-ring', 'party-banner', 'quest-board', 'market-board', 'trade-post', 'canary-shrine', 'no-real-value Enjin Canary certificate request', 'Jade Lantern Court', '25 * 18']
  },
  {
    file: 'apps/game/tests/map-event-behavior.test.ts',
    includes: ['Mochi town event behavior', 'Welcome NPC dialog', 'Mochirii Guild Seal', 'spirit-care', 'bond 5/5', 'habitat-grove', 'journal-pavilion', 'training-ring', 'quest-board', 'market-board', 'trade-post', 'no-real-value Enjin Canary certificate request', 'Wallet Daemon services']
  },
  {
  ...
  },
  {
    ...
    includes: ['alpha-visual-review.json', 'alpha-visual-review.md', 'readGitState', 'manualPromptGate', 'pending-human-review', 'alpha:manual-prompt-review', 'observerMovement', 'guild-seal-chest', 'habitat-grove', 'journal-pavilion', 'training-ring', 'party-banner', 'quest-board', 'Jade Lantern Court']
  },
  {
