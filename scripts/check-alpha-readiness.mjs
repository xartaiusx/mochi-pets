...
const checks = [
  ...
  },
  {
    ...
    includes: ['noRealValue: true', "network: 'CANARY'", 'spiritCapture: true', 'routeInvitations: true', 'spiritJournal: true', 'fieldExpeditions: true', 'techniqueMastery: true', 'battleTactics: true', 'guildRankTrials: true', 'spiritGrowthRites: true', 'questChains: true', 'affinityTrials: true', 'partyFormation: true', 'sparringLadder: true', "'spirit.capture'", "'spirit.route_invite'", "'spirit.journal'", "'world.expedition'", "'spirit.technique'", "'battle.tactic_scroll'", "'guild.rank_trial'", "'spirit.growth_rite'", "'party.set'", "'battle.affinity_trial'", "'battle.spar_ladder'", "'chain.operation_update'"]
  },
  {
  ...
  },
  {
    ...
    includes: ['cloudbell-reed-bank', 'aozhen', 'Silk Market Kindness', 'Skybell Spar', 'selectMochiSpiritQuest', 'resolveMochiSpiritQuestProgress', 'quest-chain']
  },
  {
