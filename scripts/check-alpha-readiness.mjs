...
const checks = [
  ...
  },
  {
    ...
    includes: ['noRealValue: true', "network: 'CANARY'", 'spiritCapture: true', 'spiritJournal: true', 'techniqueMastery: true', 'affinityTrials: true', 'partyFormation: true', 'sparringLadder: true', "'spirit.capture'", "'spirit.journal'", "'spirit.technique'", "'party.set'", "'battle.affinity_trial'", "'battle.spar_ladder'", "'chain.operation_update'"]
  },
  {
  ...
  },
  {
    ...
    includes: ['BRIDGE_EVENTS.auth', 'Authorization', 'lirabao-canary-certificate', 'chain.withdraw_request', 'data-presence-label', 'data-profile-label', 'data-alpha-local-action="profile.view"', 'profileViewed', 'data-guild-label', 'data-alpha-local-action="guild.buddy"', 'guildBuddyProof', 'data-status-label', 'data-alpha-local-action="status.set"', 'statusMood', 'data-alpha-action="spirit.capture"', 'captureProof', 'data-alpha-action="spirit.attune"', 'attunedSpiritIds', 'data-alpha-action="spirit.journal"', 'journalProof', 'data-alpha-action="spirit.technique"', 'techniqueProof', 'data-alpha-action="battle.affinity_trial"', 'affinityProof', 'data-alpha-action="party.set"', 'partyIds', 'data-alpha-action="spirit.train"', 'trainingXp', 'data-alpha-action="battle.spar_ladder"', 'sparLadderXp', 'data-alpha-action="spirit.raise"', 'raisingProof', 'data-alpha-local-action="spirit.inspect"', 'lastInspectedSpiritId', 'data-alpha-action="quest.accept"', 'activeQuestId', 'data-alpha-action="quest.progress"', 'completedQuestSteps', 'configured-preview-stub']
  },
  {
  ...
  },
  {
    ...
    includes: ['/healthz', '/play', '/embed', '/integration/game-manifest.json', '/integration/alpha/action', '/integration/alpha/enjin/submit', 'buildAlphaActionRequest', 'getSupabaseEdgeConfig', 'ledgerVersion: 1', "source: 'local-alpha-ledger'", "alphaStopPoint: 'alpha-rc-ready'", "chainNetwork: 'CANARY'", 'requireGameServerToken', 'confirmNoRealValue', 'ALPHA_ACTION_TYPES.includes', 'spirit.capture', 'spirit.attune', 'spirit.journal', 'spirit.technique', 'party.set', 'battle.affinity_trial', 'battle.spar_ladder', 'spirit.train', 'spirit.raise', 'quest.accept', 'quest.progress', 'configured-preview-stub']
  },
  {
  ...
  },
  {
    ...
    includes: ['Mochi town map object contract', 'runtimeEventPlacements', 'welcome-npc', 'guild-seal-chest', 'care-shrine', 'habitat-grove', 'journal-pavilion', 'technique-dojo', 'affinity-dais', 'training-ring', 'party-banner', 'quest-board', 'market-board', 'trade-post', 'canary-shrine', 'no-real-value Enjin Canary certificate request', 'Jade Lantern Court', '25 * 18']
  },
  {
    file: 'apps/game/tests/map-event-behavior.test.ts',
    includes: ['Mochi town event behavior', 'Welcome NPC dialog', 'Mochirii Guild Seal', 'spirit-care', 'bond 5/5', 'habitat-grove', 'journal-pavilion', 'technique-dojo', 'affinity-dais', 'training-ring', 'quest-board', 'market-board', 'trade-post', 'no-real-value Enjin Canary certificate request', 'Wallet Daemon services']
  },
  {
  ...
  },
  {
    ...
    includes: ['chain.withdraw_request', 'spirit.capture', 'spirit.attune', 'spirit.journal', 'spirit.technique', 'battle.affinity_trial', 'party.set', 'battle.spar_ladder', 'spirit.train', 'spirit.raise', 'quest.accept', 'quest.progress', 'local-alpha-ledger', 'ledgerVersion=1', 'alphaStopPoint', 'chainNetwork', 'canvasMovement.changedAfterFirstTabMove=true', 'lirabao-canary-certificate', '/integration/alpha/enjin/submit', 'invalid_game_server_token', 'configured-preview-stub']
  },
  {
  ...
  },
  {
    ...
    includes: ['alpha-visual-review.json', 'alpha-visual-review.md', 'readGitState', 'manualPromptGate', 'pending-human-review', 'alpha:manual-prompt-review', 'observerMovement', 'guild-seal-chest', 'habitat-grove', 'journal-pavilion', 'technique-dojo', 'affinity-dais', 'techniqueMastery', 'affinityTrial', 'training-ring', 'party-banner', 'quest-board', 'Jade Lantern Court']
  },
  {
