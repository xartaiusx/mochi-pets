...
const report = {
  ...
  scope: 'No-cost localhost Alpha RC suite. Builds once, starts the built Express runtime with throwaway env, runs endpoint/acceptance/load/browser/operator smokes, and shuts down the server.',
  runId,
  baseUrl,
  saveDir,
  commands: [],
