...
assert(browserPresence.data?.hudAction?.state?.wayfarerChronicleScore >= 52, 'HUD action proof must include a passing chronicle score');
assert(browserPresence.data?.hudAction?.state?.wayfarerChronicleRequiredScore === 52, 'HUD action proof must include the wayfarer chronicle requirement');
...
assert(browserPresence.data?.hudAction?.state?.guildAscensionScore >= 44, 'HUD action proof must include a passing guild ascension score');
assert(browserPresence.data?.hudAction?.state?.guildAscensionRequiredScore === 44, 'HUD action proof must include the guild ascension score requirement');
...
const report = {
  ...
  machineReview: {
    ...
    hudActionLoop: {
      ...
      wayfarerChronicle: browserPresence.data?.hudAction?.state?.wayfarerChronicleProof === true && browserPresence.data?.hudAction?.state?.wayfarerChronicleScore >= 52,
      guildAscensionTrial: browserPresence.data?.hudAction?.state?.guildAscensionProof === true && browserPresence.data?.hudAction?.state?.guildAscensionScore >= 44,
