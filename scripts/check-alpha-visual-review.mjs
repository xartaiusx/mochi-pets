...
assert(browserPresence.data?.hudAction?.state?.summitCircuitScore >= 76, 'HUD action proof must include a passing summit circuit score');
assert(browserPresence.data?.hudAction?.state?.summitCircuitRequiredScore === 76, 'HUD action proof must include the summit circuit requirement');
...
const report = {
  ...
  machineReview: {
    ...
    hudActionLoop: {
      ...
      summitCircuit: browserPresence.data?.hudAction?.state?.summitCircuitProof === true && browserPresence.data?.hudAction?.state?.summitCircuitScore >= 76,
