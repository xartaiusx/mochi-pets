...
assert(browserPresence.data?.hudAction?.state?.wayfarerChronicleScore >= 70, 'HUD action proof must include a passing chronicle score');
assert(browserPresence.data?.hudAction?.state?.wayfarerChronicleRequiredScore === 70, 'HUD action proof must include the wayfarer chronicle requirement');
...
assert(browserPresence.data?.hudAction?.state?.guildAscensionScore >= 59, 'HUD action proof must include a passing guild ascension score');
assert(browserPresence.data?.hudAction?.state?.guildAscensionRequiredScore === 59, 'HUD action proof must include the guild ascension score requirement');
...
const report = {
  ...
  machineReview: {
    ...
    hudActionLoop: {
      ...
      wayfarerChronicle: browserPresence.data?.hudAction?.state?.wayfarerChronicleProof === true && browserPresence.data?.hudAction?.state?.wayfarerChronicleScore >= 70,
      guildAscensionTrial: browserPresence.data?.hudAction?.state?.guildAscensionProof === true && browserPresence.data?.hudAction?.state?.guildAscensionScore >= 59,
