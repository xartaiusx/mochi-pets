...
assert(browserPresence.data?.hudAction?.state?.encounterRotationScore >= 40, 'HUD action proof must include a passing encounter rotation score');
assert(browserPresence.data?.hudAction?.state?.encounterRotationRequiredScore === 40, 'HUD action proof must include the encounter rotation requirement');
...
assert(browserPresence.data?.hudAction?.state?.encounterAtlasScore >= 48, 'HUD action proof must include a passing encounter atlas score');
assert(browserPresence.data?.hudAction?.state?.encounterAtlasRequiredScore === 48, 'HUD action proof must include the encounter atlas requirement');
...
const report = {
  ...
  machineReview: {
    ...
    hudActionLoop: {
      ...
      encounterRotation: browserPresence.data?.hudAction?.state?.encounterRotationProof === true && browserPresence.data?.hudAction?.state?.encounterRotationScore >= 40,
      encounterAtlas: browserPresence.data?.hudAction?.state?.encounterAtlasProof === true && browserPresence.data?.hudAction?.state?.encounterAtlasScore >= 48,
