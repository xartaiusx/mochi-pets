...
- Social loop works: local guild buddy proof, chat/emote, two-tab presence, Jade Kinship Album proof, Jade Banner Tournament proof, Jade Courtyard Rally proof, Jade Scroll Story Chapter proof, Jade Insignia Case proof, Jade Wayfarer Chronicle proof, and Jade Court Ascension Trial proof.
