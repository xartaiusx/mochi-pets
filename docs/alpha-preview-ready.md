...
- Mochi Spirits loop works: attune, bond, care, Moonbridge/Cloudbell field route scouting, Jintari/Aozhen route spirit invitation, Jade Cloudbell route mastery, technique mastery, tactic scroll planning, guild rank trial proof, Moonwell growth rite proof, affinity trial, train, raise, inspect, first-chain roleplay quest completion, bond growth, 3/3 journal/status, and active spirit status.
