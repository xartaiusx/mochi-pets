...
- Mochi Spirits loop works: attune, bond, care, field route scouting, route spirit invitation, technique mastery, affinity trial, train, raise, inspect, roleplay quest progress, bond growth, journal/status, and active spirit status.
