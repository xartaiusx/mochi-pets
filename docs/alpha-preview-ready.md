...
- Mochi Spirits loop works: attune, bond, care, Moonbridge/Cloudbell field route scouting, Jintari/Aozhen route spirit invitation, Jade Cloudbell route mastery, technique mastery, tactic scroll planning, guild rank trial proof, Moonwell growth rite proof, affinity trial, three-spirit party formation, Triune Jade Harmony proof, Jade Echo Concord social battle proof, Jade Mirror Team Match proof, train, raise, inspect, first-chain roleplay quest completion, bond growth, 3/3 journal/status, and active spirit status.
