...
- Social loop works: local guild buddy proof, chat/emote, two-tab presence, Jade Encounter Atlas proof, Jade Kinship Album proof, Jade Capture Rite proof, Jade Banner Tournament proof, Jade Courtyard Rally proof, Jade Scroll Story Chapter proof, Jade Insignia Case proof, Jade Wayfarer Chronicle proof, and Jade Court Ascension Trial proof.
