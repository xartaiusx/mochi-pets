...
- `chat.send`, `emote.send`, `spirit.starter_vow`, `spirit.capture`, `spirit.route_invite`, `world.route_mastery`, `world.route_patrol`, `world.route_ecology`, `world.weather_veil`, `world.encounter_rotation`, `world.encounter_atlas`, `spirit.habitat_census`, `item.craft_writ`, `trade.exchange_accord`, `spirit.relic_attune`, `world.route_waystone`, `world.route_charter`, `spirit.nurture_rite`, `spirit.recovery_tea`, `item.provision_catalog`, `item.battle_kit`, `item.remedy_pouch`, `spirit.kinship_album`, `spirit.nursery_grove`, `spirit.bloom_ascendance`, `spirit.lineage_register`, `spirit.roster_cabinet`, `spirit.blossom_cradle`, `spirit.capture_rite`, `battle.dojo_ladder`, `battle.tournament_bracket`, `battle.rival_circle`, `battle.sifu_council`, `battle.summit_circuit`, `battle.battle_chronicle`, `spirit.habitat_bond`, `spirit.sanctuary_rite`, `spirit.research`, `spirit.compendium_complete`, `spirit.roster_archive`, `item.provision_satchel`, `spirit.care_cycle`, `spirit.temperament_concord`, `spirit.field_almanac`, `guild.commission_complete`, `guild.social_rally`, `quest.ledger_record`, `story.dialogue_scroll`, `story.chapter_complete`, `guild.insignia_case`, `guild.wayfarer_chronicle`, `guild.ascension_trial`, `spirit.attune`, `spirit.journal`, `world.expedition`, `spirit.technique`, `spirit.technique_loadout`, `battle.technique_codex`, `spirit.trait_attune`, `battle.condition_weave`, `battle.tactic_scroll`, `guild.rank_trial`, `spirit.growth_rite`, `battle.affinity_trial`, `party.set`, `party.harmony_form`, `battle.harmony_trial`, `battle.team_spar_match`, `battle.mentor_challenge`, `battle.spar_ladder`, `spirit.bond`, `spirit.care`, `spirit.train`, `spirit.raise`, `quest.accept`, `quest.progress`, `market.fixed_list`, `market.guild_receipt`, `trade.direct_offer`, `chain.withdraw_request`, `chain.deposit_request`, and `chain.operation_update` record to the no-real-value fallback ledger when Mochirii Supabase Edge Functions are not configured. The scripted payloads cover Jade Starter Vow, Moonbridge/Jintari and Cloudbell/Aozhen no-injury field accord proofs before route invitations, Jade Cloudbell route mastery, Jade Cloudbell two-tester route patrol, Jade Court Habitat Bond, Jade Court Sanctuary Rite, Jade Court Research Folio, Jade Court Spirit Compendium, Jade Court Roster Archive, Jade Roster Cabinet, Jade Blossom Cradle, Jade Court Market Receipt, Jade Court Provision Satchel, Jade Provision Catalog, Jade Battle Kit, Jade Remedy Pouch, Jade Court Care Cycle, Jade Temperament Concord, Jade Field Almanac, Jade Route Ecology Survey, Jade Weather Veil, Jade Encounter Rotation, Jade Encounter Atlas, Jade Habitat Census, Jade Court Craft Writ, Jade Exchange Accord, Jade Relic Attunement, Jade Cloudbell Waystone, Jade Route Charter, Jade Moonwell Nurture Rite, Jade Teahouse Recovery, Jade Kinship Album, Jade Nursery Grove, Jade Bloom Ascendance, Jade Lineage Register, Jade Capture Rite, Jade Dojo Ladder, Jade Banner Tournament, Jade Rival Circle, Jade Summit Circuit, Jade Battle Chronicle, Jade Court Commission Ledger, Jade Courtyard Rally, Jade Quest Ledger, Jade Dialogue Scroll, Jade Scroll Story Chapter, Jade Insignia Case, Jade Wayfarer Chronicle, Jade Court Ascension Trial, Jade Step Loadout, Jade Technique Codex, Jade Heart Trait Attunement, Jade Mirror Condition Weave, per-spirit bond milestone display through care/raise, Triune Jade Harmony, Jade Echo Concord, Jade Mirror Team Match, Silk Banner Mentor Drill, Jade Vault return preview, Canary finality no-credit review, plus the First Lantern Vow, Silk Market Kindness, and Skybell Spar quest postings. The capstone path is starter vow, market receipt, provision catalog, battle kit, remedy pouch, exchange accord, relic attunement, route charter, kinship album, nursery grove, bloom ascendance, lineage register, roster cabinet, blossom cradle, capture rite, dojo ladder, weather veil, encounter rotation, encounter atlas, habitat census, summit circuit, battle chronicle, quest ledger, dialogue scroll, story, insignia case, chronicle, and ascension, while the older story, chronicle pairing remains covered with `guild-insignia-case` ledger proof before the later capstones.
...
- `item.bond_gift` records the no-real-value Jade Bond Gift Rite payload with full Lirabao/Jintari/Aozhen roster proof, Jade Mooncake Box/Lantern Harmony Tea/Jade Thread Charm gift IDs, Jade Court Market Receipt, Jade Court Provision Satchel, Jade Court Care Cycle, profile/guild/status/chat readiness, two-tester witness, and Jade Bond Gift Ribbon proof.
- `spirit.name_banner` records the no-real-value Jade Name Banner Rite payload with full Lirabao/Jintari/Aozhen roster proof, Lirabao Lanternheart/Jintari Goldleaf Step/Aozhen Skybell Veil title records, 3/3 journal proof, compendium/archive/cabinet proof, Jade Bond Gift Rite proof, profile/guild/status/chat readiness, two-tester witness, and Jade Name Banner Tag proof.
- `quest.ledger_record` records the no-real-value Jade Quest Ledger payload with full roster proof, all three accepted and completed first-court quest postings, 3/3 journal records, two-tester presence, route mastery, route patrol, market receipt, provision satchel, commission, profile/guild/status/chat readiness, and Jade Quest Ledger Seal proof. Story, Chronicle, and Ascension payloads preserve `questLedgerProof`.
...
- `world.route_charter` records the no-real-value Jade Route Charter payload with Moonbridge/Cloudbell route records, full Lirabao/Jintari/Aozhen party proof, Jade Cloudbell route mastery, Jade Cloudbell route patrol, Jade Cloudbell Waystone, Jade Route Ecology Survey, Jade Weather Veil, Jade Encounter Atlas, Jade Habitat Census, Jade Court Provision Satchel, Jade Court Craft Writ, two-tester presence, and Jade Route Charter Slip proof. Chronicle and Ascension payloads preserve `routeCharterProof`.
...
`npm run alpha:local-site-iframe` starts the built game server and the local Mochirii `apps/web` Next server with `NEXT_PUBLIC_MOCHI_SOCIAL_URL` pointed at the local game, tester-password mode enabled, and a private `MOCHI_SOCIAL_TESTER_PASSWORD` or `MOCHI_SOCIAL_LOCAL_SITE_IFRAME_PASSWORD`. It then runs the responsive gameplay matrix with `MOCHI_SOCIAL_RESPONSIVE_REQUIRE_SITE_IFRAME=true`, writes `reports/alpha-local-site-iframe.json`, `reports/alpha-site-iframe-responsive.json`, and viewport screenshots under `reports/responsive-site-iframe/`, and shuts both local servers down.

`npm run alpha:preview-ready` writes `reports/alpha-preview-ready.json`, `reports/alpha-preview-ready.md`, and `C:\Users\xtyty\Desktop\Creds\mochi-social-alpha-preview-ready.md`. It proves the tester-entry lane separately from funded-chain Alpha RC gates by requiring current local evidence, a current `alpha:local-site-iframe` report, a dedicated responsive site-iframe report that checked the unlocked Mochirii `/games/mochi-social` iframe across all nine viewports with `MOCHI_SOCIAL_RESPONSIVE_REQUIRE_SITE_IFRAME=true`, current no-secret hygiene, completed manual prompt review, current handoff packets, synced game/site branches, and green `preview-live-gates` from an explicitly approved hosted external-gates run.
...
The browser HUD loop also clicks `story.dialogue_scroll` after the Jade Quest Ledger and before the Jade Scroll Story Chapter, then verifies the Dialogue label, `dialogueScrollProof`, three original speaker beats, Sifu Narao/Warden Meilin/Keeper Haoran speaker names, and Jade Dialogue Scroll Seal no-real-value state.
...
The browser HUD loop also clicks `world.route_charter` after the waystone and verifies the Charter label, `routeCharterProof`, charter score, route IDs, full party IDs, prerequisite proof IDs, two-tester presence, and Jade Route Charter Slip no-real-value state.
...
`npm run alpha:responsive-gameplay` opens `/play`, `/embed`, a synthetic parent page embedding `/embed`, and, when configured, the real Mochirii `/games/mochi-social` iframe across the alpha viewport matrix: 1920x1080, 1440x900, 1366x768, 1280x720, 1024x768, 932x430, 844x390, 430x932, and 390x844. It verifies the canvas and HUD render, captures ignored viewport screenshots under `reports/responsive-gameplay/`, records critical DOM rectangles plus action-button rectangles for each viewport, and writes `reports/alpha-responsive-gameplay.json`.

The gate checks for no horizontal overflow, no incoherent HUD panel overlap, central gameplay safe-area preservation, reachable first and last action buttons, focus visibility, canvas `touch-action`, overscroll containment, and editable chat behavior while movement keys are typed. It also focuses the game canvas and sends Arrow keys, WASD, Space, and Enter to prove gameplay controls prevent default browser scrolling only while the gameplay surface is focused, do not scroll the browser page, HUD scroll regions, parent page, or iframe page, and record per-key keydown plus before/after frame and parent-page scroll evidence in `reports/alpha-responsive-gameplay.json`. The report splits movement keys from interaction keys, and it synthetically verifies the legacy `Spacebar` interaction key still prevents default when the canvas is focused. The same audit verifies editable inputs preserve movement/action characters without prevented keydown events, Tab remains usable for focus movement, and unhandled keys are not hijacked. It is local-only by default; set `MOCHI_SOCIAL_RESPONSIVE_ALLOW_HOSTED_SMOKE=true` only after explicit hosted-preview approval.

For the real Mochirii page leg, set `MOCHI_SOCIAL_RESPONSIVE_SITE_BASE_URL` or `MOCHI_SOCIAL_SITE_BASE_URL` to the parent site origin and keep `MOCHI_SOCIAL_RESPONSIVE_SITE_ENTRY_PATH=/games/mochi-social` unless the website contract changes. If the parent page shows the tester-password gate, set `MOCHI_SOCIAL_TESTER_PASSWORD` privately before running the smoke; the report records only `passwordProvided: true`, never the password. Set `MOCHI_SOCIAL_RESPONSIVE_REQUIRE_SITE_IFRAME=true` when that site leg must fail instead of skip.
...
Visual review includes Jade Quest Ledger static and browser evidence: `resolveMochiQuestLedger`, `quest-ledger`, `data-alpha-action="quest.ledger_record"`, `data-quest-ledger-label`, `questLedgerProof`, and the no-real-value Jade Quest Ledger Seal.
...
Visual review includes Jade Battle Chronicle static and browser evidence: `resolveSpiritBattleChronicle`, `battle-chronicle`, `data-alpha-action="battle.battle_chronicle"`, `data-battle-chronicle-label`, `battleChronicleProof`, and the no-real-value Jade Battle Chronicle Seal.
