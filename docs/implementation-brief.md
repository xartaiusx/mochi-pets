...
- Three Mochi Spirits: Lirabao, Jintari, and Aozhen, with capture/invitation, attunement, journal records, field route scouting, route spirit invitation, technique mastery, affinity trials, party formation, spar ladder practice, bond/care/growth, training battle, raising, and roleplay quest state.
- One habitat grove, one journal pavilion, one expedition gate, one route invitation altar, one technique dojo, one affinity dais, one party banner, one no-injury training ring, and one quest board that turn Mochi Spirit progression into in-world saved alpha actions.
