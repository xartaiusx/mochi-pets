...
- Three Mochi Spirits: Lirabao, Jintari, and Aozhen, with capture/invitation, attunement, bond/care/growth, training battle, raising, journal, and roleplay quest state.
- One habitat grove, one no-injury training ring, and one quest board that turn Mochi Spirit progression into in-world saved alpha actions.
