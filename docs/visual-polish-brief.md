...
- Bottom action bar: profile, guild, mood, invite, attune, journal, scout, route invite, circuit, bond, research, dojo, tactic, trial, party, harmony, concord, match, care, train, spar, raise, inspect, quest, rank, bloom, wave, list, trade, Canary.
