...
- Spirit card: active Mochi Spirit name, invited/captured roster proof, journal records, field route scouting, route invitation proof, technique mastery, tactic scroll proof, guild rank proof, Moonwell growth rite proof, affinity trial proof, party formation, spar ladder progress, bond, growth, training, raising, and quest progress.
- Bottom action bar: profile, guild, mood, invite, attune, journal, scout, route invite, dojo, tactic, trial, party, care, train, spar, raise, inspect, quest, rank, bloom, wave, list, trade, Canary.
