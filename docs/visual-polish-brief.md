...
- Spirit card: active Mochi Spirit name, invited/captured roster proof, journal records, field route scouting, route invitation proof, technique mastery, tactic scroll proof, affinity trial proof, party formation, spar ladder progress, bond, growth, training, raising, and quest progress.
