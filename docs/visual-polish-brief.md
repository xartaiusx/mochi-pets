...
- Bottom action bar: profile, guild, mood, starter, invite, attune, journal, scout, route invite with field accord proof, circuit, patrol, bond, research, codex, archive, bag, catalog, kit, remedy, cycle, temper, almanac, ecology, veil, encounter atlas, census, craft, waystone, nurture, recover, kinship album, nursery, ascendance, lineage, capture rite, ladder, bracket, rival, council, commission, rally, story, dojo, tactic, moves, technique codex, weave, matrix, trial, party, harmony, concord, match, mentor, care, train, spar, raise, inspect, quest, rank, bloom, wave, list, trade, Canary.
...
- The Jade Starter Vow, Jade Court Market Receipt proof, Jade Provision Catalog proof, Jade Battle Kit proof, Jade Remedy Pouch proof, Jade Weather Veil proof, Jade Encounter Rotation proof, Jade Encounter Atlas, Jade Habitat Census, Jade Exchange Accord proof, Jade Relic Attunement proof, Jade Teahouse Recovery, Jade Kinship Album, Jade Nursery Grove, Jade Bloom Ascendance, Jade Lineage Register, Jade Capture Rite, Jade Dojo Ladder proof, Jade Rival Circle, Jade Sifu Council proof, Jade Summit Circuit proof, Jade Affinity Matrix, Jade Technique Codex, and insignia case proofs are content-only and should keep the same compact HUD kit rhythm as nearby starter, market, bag, remedy, ecology, atlas, craft, relic, nurture, rival, summit, commission, story, and chronicle actions.
