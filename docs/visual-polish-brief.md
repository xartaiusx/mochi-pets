...
- Bottom action bar: profile, guild, mood, starter, invite, attune, journal, scout, route invite with field accord proof, circuit, patrol, bond, research, codex, archive, bag, cycle, temper, almanac, ecology, encounter atlas, craft, waystone, nurture, recover, kinship album, nursery, ascendance, lineage, capture rite, ladder, bracket, rival, council, commission, rally, story, dojo, tactic, moves, technique codex, weave, matrix, trial, party, harmony, concord, match, mentor, care, train, spar, raise, inspect, quest, rank, bloom, wave, list, trade, Canary.
