...
- Bottom action bar: profile, guild, mood, invite, attune, journal, scout, route invite, circuit, dojo, tactic, trial, party, care, train, spar, raise, inspect, quest, rank, bloom, wave, list, trade, Canary.
