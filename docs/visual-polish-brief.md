...
- First screen should read as Jade Lantern Court: a social guild town with Sifu Narao, Mochi Spirits, guild seal chest, habitat grove, journal pavilion, technique dojo, affinity dais, party banner, training ring, quest board, market board, trade post, and Canary shrine.
...
- Spirit card: active Mochi Spirit name, invited/captured roster proof, journal records, technique mastery, affinity trial proof, party formation, spar ladder progress, bond, growth, training, raising, and quest progress.
- Bottom action bar: profile, guild, mood, invite, attune, journal, dojo, trial, party, care, train, spar, raise, inspect, quest, wave, list, trade, Canary.
