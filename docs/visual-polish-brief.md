...
- Bottom action bar: profile, guild, mood, invite, attune, journal, scout, route invite, circuit, bond, research, codex, bag, commission, dojo, tactic, moves, weave, trial, party, harmony, concord, match, mentor, care, train, spar, raise, inspect, quest, rank, bloom, wave, list, trade, Canary.
