...
- First screen should read as Jade Lantern Court: a social guild town with Sifu Narao, Mochi Spirits, guild seal chest, habitat grove, training ring, quest board, market board, trade post, and Canary shrine.
...
- Spirit card: active Mochi Spirit name, invited/captured roster proof, bond, growth, training, raising, and quest progress.
- Bottom action bar: profile, guild, mood, invite, attune, care, train, raise, inspect, quest, wave, list, trade, Canary.
